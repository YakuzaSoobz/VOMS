...
Public Class EmployeeSalesPerProduct
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmployeeSalesPerProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "M.I.S.S_Vendor_Order_Management_System.EmployeeSalesPerProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Time_Period() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEmployeeSalesPerProduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmployeeSalesPerProduct = New EmployeeSalesPerProduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
