...
Public Class TotalSupplierCost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "M.I.S.S_Vendor_Order_Management_System.TotalSupplierCost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalSupplierCost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalSupplierCost = New TotalSupplierCost()
        rpt.Site = Me.Site
        Return rpt
    End Function
